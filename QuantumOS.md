...
The [quantum-os](https://github.com/rchain-community/quantum-os) browser app runs ZFA evaluation live in the browser (Rust/WASM kernel). After connecting at **https://rholang.io/quantum-os/**, type in the chat input:
...
- **See the room** — `/render` opens an animation of the current room: its perspectives (peers) bound to the shared room closure, its closures (lemmas), and groups, in the frequency-as-space/time/colour idiom of the QLF [Spectral Spacetime Constructor](https://rholang.io/quantum-logical-framework/spacetime_constructor.html) ([`Spacetime_Constructor.md`](Spacetime_Constructor.md)).

New to it? Start with the **[User Guide](https://github.com/rchain-community/quantum-os/blob/main/User_Guide.md)**, or just **[open a room](https://rholang.io/quantum-os/)** (and [My room](https://github.com/rchain-community/quantum-os/blob/main/MyRoom.md)).
