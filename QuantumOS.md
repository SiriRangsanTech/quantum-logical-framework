...
- **See the room** — `/render` opens an animation of the current room: its perspectives (peers) bound to the shared room closure, its closures (lemmas), and groups, in the frequency-as-space/time/colour idiom of the QLF [Spectral Spacetime Constructor](https://jimscarver.github.io/quantum-logical-framework/spacetime_constructor.html) ([`Spacetime_Constructor.md`](Spacetime_Constructor.md)).
