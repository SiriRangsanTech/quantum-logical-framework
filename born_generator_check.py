...
print("      components, not the norm of a single component.")
print()
print("   RESOLVED (QLF_Degeneracy): the decomposition is fixed by mu4.  Every closed")
print("   history folds to a Pauli scalar in {+-1, +-i} (QLF_Pauli), so each way carries a")
print("   UNIT amplitude with a mu4 phase and a branch amplitude is their SUM -- hence every")
print("   weight is automatically a Z[i] norm.  The failures above are not a defect: COUNTS")
print("   ARE NOT WEIGHTS.  weight = |sum of phases|^2, and the gap from the count IS")
print("   interference -- orthogonal phases give weight = count (which is exactly why the")
print("   pair generator matched: its two ways are the orderings +- and -+), aligned give")
print("   n^2, opposed give 0.  Open and distinct: WHICH phase a given way carries.")
